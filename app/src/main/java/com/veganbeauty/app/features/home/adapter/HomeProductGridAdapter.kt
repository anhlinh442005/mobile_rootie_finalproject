...
class HomeProductGridAdapter(
    private val onItemClick: (ProductEntity) -> Unit = {},
    private val onAddToCart: (ProductEntity) -> Unit = {}
) : ListAdapter<ProductEntity, HomeProductGridAdapter.ViewHolder>(DiffCallback()) {

    private val priceFormatter = NumberFormat.getCurrencyInstance(Locale("vi", "VN"))

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = HomeItemProductGridBinding.inflate(
    ...
    inner class ViewHolder(
        private val binding: HomeItemProductGridBinding
